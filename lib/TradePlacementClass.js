...
class TradePlacementClass {
  ...
  actOnUserWebsocketStream = (data) => {
    ...
    if (d.e === "ORDER_TRADE_UPDATE") {
	  //console.log("order update",d)
      //console.log("order update", d.e, d.o.i, d.o.x, d.o.X, d.o.ot, d.o.ap, d.o.T, d.o.S, d.o.sp, d.o.s);
      this.feedbackConnector.connection.emit("feedback", {
        label: "ORDER_UPDATE",
        //payload: [d.e, d.o.i, d.o.x, d.o.X, d.o.ot, d.o.ap],
      payload:[ d.e, d.o.i, d.o.x, d.o.X, d.o.ot, d.o.ap, d.o.T, d.o.S, d.o.sp, d.o.s,d.o.q,d.o.l]
      });
    }
  };
