class TradingStrategyClass {
  constructor(parameters, modules) {
    ...
    this.BackendDataEmitterClass = modules.BackendDataEmitterClass;
  ...
  initializeClasses = () => {
    ...
    this.sg = new this.SignalGeneratorClass(this.intervals);
    ...
    //backendurl logger
    this.bu = new this.BackendDataEmitterClass(this.backendURL);
  };
  ...
  connectConnectorsToDestination = () => {
    ...
    this.SignalGeneratorToTradeManagement.connectTarget(this.bu);
